...
# [categories.iloc[0]['url']] to get first url,
# categories['url'] for all urls
# init.parallel(scraper.parse_url, [categories.iloc[0]['url']])
init.parallel(scraper.parse_url, categories['url'])
